...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftConfigurationsBlockDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 13, 17, 17);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "RotationAxes", _g_get_RotationAxes);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "RotationAxes", _s_set_RotationAxes);
        ...
        static int _m_GetBoundingBox(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 6&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<Minecraft.IWorld>(L, 5)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 6)) 
                {
                    ...
                    bool _checkCollisionFlags = LuaAPI.lua_toboolean(L, 6);
                    
                        var gen_ret = gen_to_be_invoked.GetBoundingBox( _x, _y, _z, _world, _checkCollisionFlags );
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3Int>(L, 2)&& translator.Assignable<Minecraft.IWorld>(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _checkCollisionFlags = LuaAPI.lua_toboolean(L, 4);
                    
                        var gen_ret = gen_to_be_invoked.GetBoundingBox( _position, _world, _checkCollisionFlags );
                        translator.PushAny(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_RotationAxes(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Minecraft.Configurations.BlockData gen_to_be_invoked = (Minecraft.Configurations.BlockData)translator.FastGetCSObj(L, 1);
                translator.PushMinecraftConfigurationsBlockRotationAxes(L, gen_to_be_invoked.RotationAxes);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_RotationAxes(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Minecraft.Configurations.BlockData gen_to_be_invoked = (Minecraft.Configurations.BlockData)translator.FastGetCSObj(L, 1);
                Minecraft.Configurations.BlockRotationAxes gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.RotationAxes = gen_value;
