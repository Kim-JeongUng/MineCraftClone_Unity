...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftEntitiesEntityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Minecraft.Entities.Entity);
			Utils.BeginObjectRegister(type, L, translator, 0, 5, 12, 7);
        ...
        {
            return LuaAPI.luaL_error(L, "Minecraft.Entities.Entity does not have a constructor!");
        }
        ...
        static int _m_InitializeEntityIfNot(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.Entities.Entity gen_to_be_invoked = (Minecraft.Entities.Entity)translator.FastGetCSObj(L, 1);
        ...
        static int _e_OnCollisions(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Minecraft.Entities.Entity.OnCollisions!");
            return 0;
        }
