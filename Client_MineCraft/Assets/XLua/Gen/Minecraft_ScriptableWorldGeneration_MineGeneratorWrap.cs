    ...
    public class MinecraftScriptableWorldGenerationMineGeneratorWrap 
    {
        ...
        static int _m_Generate(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 8&& translator.Assignable<Minecraft.IWorld>(L, 2)&& translator.Assignable<Minecraft.ChunkPos>(L, 3)&& translator.Assignable<Minecraft.Configurations.BlockData[,,]>(L, 4)&& translator.Assignable<UnityEngine.Quaternion[,,]>(L, 5)&& translator.Assignable<byte[,]>(L, 6)&& translator.Assignable<Minecraft.ScriptableWorldGeneration.GenerationHelper>(L, 7)&& translator.Assignable<Minecraft.ScriptableWorldGeneration.GenerationContext>(L, 8)) 
                {
