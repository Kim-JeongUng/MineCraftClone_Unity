...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftChunkWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 14, 5, 1);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetBlockRotation", _m_GetBlockRotation);
        ...
        static int _m_GetRawDataNoCheck(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Quaternion[,,] _rotations;
                    Minecraft.Collections.NibbleArray _skyLights;
                    byte[,] _heightMap;
                    
                    gen_to_be_invoked.GetRawDataNoCheck( out _pos, out _world, out _blocks, out _rotations, out _skyLights, out _heightMap );
        ...
        static int _m_SetBlock(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Minecraft.ModificationSource _source;translator.Get(L, 7, out _source);
                    
                        var gen_ret = gen_to_be_invoked.SetBlock( _x, _y, _z, _value, _rotation, _source );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetBlockRotation(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& translator.Assignable<UnityEngine.Quaternion>(L, 5)) 
                {
                    int _x = LuaAPI.xlua_tointeger(L, 2);
                    int _y = LuaAPI.xlua_tointeger(L, 3);
                    int _z = LuaAPI.xlua_tointeger(L, 4);
                    UnityEngine.Quaternion _defaultValue;translator.Get(L, 5, out _defaultValue);
                    
                        var gen_ret = gen_to_be_invoked.GetBlockRotation( _x, _y, _z, _defaultValue );
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    int _z = LuaAPI.xlua_tointeger(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.GetBlockRotation( _x, _y, _z );
                        translator.PushUnityEngineQuaternion(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Minecraft.Chunk.GetBlockRotation!");
