    ...
    public class MinecraftRenderingLightingUtilityWrap 
    {
        ...
        static int _m_AmbientOcclusion_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3Int _pos;translator.Get(L, 1, out _pos);
                    Minecraft.Configurations.BlockFace _face;translator.Get(L, 2, out _face);
                    Minecraft.Configurations.BlockFaceCorner _corner;translator.Get(L, 3, out _corner);
                    Minecraft.IWorldRAccessor _accessor = (Minecraft.IWorldRAccessor)translator.GetObject(L, 4, typeof(Minecraft.IWorldRAccessor));
                    bool _fastMode = LuaAPI.lua_toboolean(L, 5);
                    
                        var gen_ret = Minecraft.Rendering.LightingUtility.AmbientOcclusion( _pos, _face, _corner, _accessor, _fastMode );
                        translator.PushUnityEngineVector2(L, gen_ret);
