...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<Minecraft.Rendering.BlockMeshVertexData>(translator.PushMinecraftRenderingBlockMeshVertexData, translator.Get, translator.UpdateMinecraftRenderingBlockMeshVertexData);
				...
				translator.RegisterPushAndGetAndUpdate<Minecraft.Configurations.BlockRotationAxes>(translator.PushMinecraftConfigurationsBlockRotationAxes, translator.Get, translator.UpdateMinecraftConfigurationsBlockRotationAxes);
        ...
        int MinecraftRenderingBlockMeshVertexData_TypeID = -1;
        public void PushMinecraftRenderingBlockMeshVertexData(RealStatePtr L, Minecraft.Rendering.BlockMeshVertexData val)
        {
            if (MinecraftRenderingBlockMeshVertexData_TypeID == -1)
            {
			    bool is_first;
                MinecraftRenderingBlockMeshVertexData_TypeID = getTypeId(L, typeof(Minecraft.Rendering.BlockMeshVertexData), out is_first);
				
            }
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 44, MinecraftRenderingBlockMeshVertexData_TypeID);
            if (!CopyByValue.Pack(buff, 0, val))
            {
                throw new Exception("pack fail fail for Minecraft.Rendering.BlockMeshVertexData ,value="+val);
            }
			
        }
		
        public void Get(RealStatePtr L, int index, out Minecraft.Rendering.BlockMeshVertexData val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != MinecraftRenderingBlockMeshVertexData_TypeID)
				{
				    throw new Exception("invalid userdata for Minecraft.Rendering.BlockMeshVertexData");
				}
				
                IntPtr buff = LuaAPI.lua_touserdata(L, index);if (!CopyByValue.UnPack(buff, 0, out val))
                {
                    throw new Exception("unpack fail for Minecraft.Rendering.BlockMeshVertexData");
                }
            }
			else if (type ==LuaTypes.LUA_TTABLE)
			{
            ...
            {
                val = (Minecraft.Rendering.BlockMeshVertexData)objectCasters.GetCaster(typeof(Minecraft.Rendering.BlockMeshVertexData))(L, index, null);
            }
        }
		
        public void UpdateMinecraftRenderingBlockMeshVertexData(RealStatePtr L, int index, Minecraft.Rendering.BlockMeshVertexData val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  val))
                {
                    throw new Exception("pack fail for Minecraft.Rendering.BlockMeshVertexData ,value="+val);
                }
            }
        ...
        int MinecraftConfigurationsBlockRotationAxes_TypeID = -1;
		int MinecraftConfigurationsBlockRotationAxes_EnumRef = -1;
        
        public void PushMinecraftConfigurationsBlockRotationAxes(RealStatePtr L, Minecraft.Configurations.BlockRotationAxes val)
        {
            if (MinecraftConfigurationsBlockRotationAxes_TypeID == -1)
            {
			    bool is_first;
                MinecraftConfigurationsBlockRotationAxes_TypeID = getTypeId(L, typeof(Minecraft.Configurations.BlockRotationAxes), out is_first);
				
				if (MinecraftConfigurationsBlockRotationAxes_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(Minecraft.Configurations.BlockRotationAxes));
				    MinecraftConfigurationsBlockRotationAxes_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, MinecraftConfigurationsBlockRotationAxes_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, MinecraftConfigurationsBlockRotationAxes_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for Minecraft.Configurations.BlockRotationAxes ,value="+val);
            }
			
			LuaAPI.lua_getref(L, MinecraftConfigurationsBlockRotationAxes_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out Minecraft.Configurations.BlockRotationAxes val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != MinecraftConfigurationsBlockRotationAxes_TypeID)
				{
				    throw new Exception("invalid userdata for Minecraft.Configurations.BlockRotationAxes");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for Minecraft.Configurations.BlockRotationAxes");
                }
				val = (Minecraft.Configurations.BlockRotationAxes)e;
                
            }
            else
            {
                val = (Minecraft.Configurations.BlockRotationAxes)objectCasters.GetCaster(typeof(Minecraft.Configurations.BlockRotationAxes))(L, index, null);
            }
        }
		
        public void UpdateMinecraftConfigurationsBlockRotationAxes(RealStatePtr L, int index, Minecraft.Configurations.BlockRotationAxes val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for Minecraft.Configurations.BlockRotationAxes ,value="+val);
                }
            }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			else if (type == typeof(Minecraft.Rendering.BlockMeshVertexData[]))
			{
			    Minecraft.Rendering.BlockMeshVertexData[] array = obj as Minecraft.Rendering.BlockMeshVertexData[];
				translator.PushMinecraftRenderingBlockMeshVertexData(L, array[index]);
				return true;
			}
			...
			else if (type == typeof(Minecraft.Configurations.BlockRotationAxes[]))
			{
			    Minecraft.Configurations.BlockRotationAxes[] array = obj as Minecraft.Configurations.BlockRotationAxes[];
				translator.PushMinecraftConfigurationsBlockRotationAxes(L, array[index]);
				return true;
			}
            return false;
		}
