...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftConfigurationsBlockMeshWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Minecraft.Configurations.BlockMesh();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Minecraft.Configurations.BlockMesh constructor!");
        ...
        static int _g_get_Faces(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.Configurations.BlockMesh gen_to_be_invoked = (Minecraft.Configurations.BlockMesh)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Faces);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_Faces(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.Configurations.BlockMesh gen_to_be_invoked = (Minecraft.Configurations.BlockMesh)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.Faces = (Minecraft.Configurations.BlockMesh.FaceData[])translator.GetObject(L, 2, typeof(Minecraft.Configurations.BlockMesh.FaceData[]));
