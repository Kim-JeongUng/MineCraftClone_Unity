...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftConfigurationsBlockRotationAxesWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(Minecraft.Configurations.BlockRotationAxes), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(Minecraft.Configurations.BlockRotationAxes), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(Minecraft.Configurations.BlockRotationAxes), L, null, 4, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "None", Minecraft.Configurations.BlockRotationAxes.None);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "AroundYAxis", Minecraft.Configurations.BlockRotationAxes.AroundYAxis);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "AroundXOrZAxis", Minecraft.Configurations.BlockRotationAxes.AroundXOrZAxis);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(Minecraft.Configurations.BlockRotationAxes), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushMinecraftConfigurationsBlockRotationAxes(L, (Minecraft.Configurations.BlockRotationAxes)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
			    ...
			    if (LuaAPI.xlua_is_eq_str(L, 1, "None"))
                {
                    translator.PushMinecraftConfigurationsBlockRotationAxes(L, Minecraft.Configurations.BlockRotationAxes.None);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "AroundYAxis"))
                {
                    translator.PushMinecraftConfigurationsBlockRotationAxes(L, Minecraft.Configurations.BlockRotationAxes.AroundYAxis);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "AroundXOrZAxis"))
                {
                    translator.PushMinecraftConfigurationsBlockRotationAxes(L, Minecraft.Configurations.BlockRotationAxes.AroundXOrZAxis);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for Minecraft.Configurations.BlockRotationAxes!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for Minecraft.Configurations.BlockRotationAxes! Expect number or string, got + " + lua_type);
            }
