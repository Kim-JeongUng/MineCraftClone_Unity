...
namespace XLua
{
    public static partial class CopyByValue
    {
		...
		public static void UnPack(ObjectTranslator translator, RealStatePtr L, int idx, out Minecraft.Rendering.BlockMeshVertexData val)
		{
		    val = new Minecraft.Rendering.BlockMeshVertexData();
            int top = LuaAPI.lua_gettop(L);
        ...
        public static bool Pack(IntPtr buff, int offset, Minecraft.Rendering.BlockMeshVertexData field)
        {
        ...
        public static bool UnPack(IntPtr buff, int offset, out Minecraft.Rendering.BlockMeshVertexData field)
        {
            field = default(Minecraft.Rendering.BlockMeshVertexData);
