...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Minecraft.Configurations.BlockRotationAxes), MinecraftConfigurationsBlockRotationAxesWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(Minecraft.Rendering.BlockMeshVertexData), MinecraftRenderingBlockMeshVertexDataWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate UnityEngine.Vector3Int __GEN_DELEGATE1( UnityEngine.Vector3 vec);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.Vector3), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE1(Minecraft.MathUtility.RoundToInt)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
