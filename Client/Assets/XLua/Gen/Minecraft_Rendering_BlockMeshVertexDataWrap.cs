...
namespace XLua.CSObjectWrap
{
    ...
    public class MinecraftRenderingBlockMeshVertexDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Minecraft.Rendering.BlockMeshVertexData);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "VertexAttributes", Minecraft.Rendering.BlockMeshVertexData.VertexAttributes);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.PushMinecraftRenderingBlockMeshVertexData(L, default(Minecraft.Rendering.BlockMeshVertexData));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Minecraft.Rendering.BlockMeshVertexData constructor!");
        ...
        static int _g_get_PositionOS(RealStatePtr L)
        {
		    try {
                ...
                Minecraft.Rendering.BlockMeshVertexData gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
        ...
        static int _s_set_PositionOS(RealStatePtr L)
        {
		    try {
                ...
                translator.UpdateMinecraftRenderingBlockMeshVertexData(L, 1, gen_to_be_invoked);
